...
type ModalName = 'addContext' | 'editContext' | 'addObject' | 'editObject' | 'addProject' | 'editProject' | 'deleteConfirm';
...
export default function WorkspaceOverviewPage() {
  ...
  const viewLevel = 'workspace' as const;
  const project = '';
  ...
  const displayedContexts = [...workspaceContexts, ...globalContexts];
  ...
  const displayedObjects = [...workspaceObjects, ...globalObjects];
  ...
  const handleRemoveObjectFromWorkspace = async (obj: ObjectType) => {
    ...
    const hasNoAvailability =
      obj.availableInProjects.length === 0 && updatedWorkspaces.length === 0 && !obj.availableGlobal;
            ...
            <div className="flex h-full w-full">
              ...
              <div className="flex-1 min-w-0 overflow-hidden">
                <ContextsObjectsPanel
                  ...
                  onRemoveObject={handleRemoveObjectFromWorkspace}
                  items={items}
                  projects={projects}
                  workspace={workspace}
                  project={project}
